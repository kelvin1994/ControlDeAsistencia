...
<div class="page-content">
  ...
  <h4 class="text-center text-secodary">REGISTRO DE USUARIOS</h4>
  ...
  ?>
    ...
    <a href="registro_usuario.php" class="btn btn-primary btn-rounded mb-2"><i class="fa-solid fa-user-plus"></i>&nbsp;Registrar</a>
    ...
    <tr>
      ...
      <td>
           <a href=""  data-toggle="modal" data-target="#exampleModal<?= $datos->id_usuario ?>" class="btn btn-warning"><i class="fa-solid fa-pen-to-square"></i></a>
            <a class="btn btn-danger" href="usuario.php?id=<?= $datos->id_usuario ?>" onclick="advertencia(event)"><i class="fa-solid fa-trash"></i></a>
