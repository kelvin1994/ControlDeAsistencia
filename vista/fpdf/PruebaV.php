...
class PDF extends FPDF
{
   ...
   function Header()
   {
      ...
      $this->Image('logo_caritas.png', 170, 10, 30); //logo de la empresa,moverDerecha,moverAbajo,tamañoIMG
      $this->SetFont('Arial', 'B', 19); //tipo fuente, negrita(B-I-U-BIU), tamañoTexto
      $this->Cell(45); // Movernos a la derecha
      $this->SetTextColor(0, 0, 0); //color
      //creamos una celda o fila
      $this->Cell(110, 15, utf8_decode('Caritas Abancay'), 0, 1, 'C', 0); // AnchoCelda,AltoCelda,titulo,borde(1-0),saltoLinea(1-0),posicion(L-C-R),ColorFondo(1-0)
      ...
      $this->Cell(96, 10, utf8_decode("Dirección : "), 0, 0, '', 0);
     

      $this->Cell(-75);  // mover a la derecha
      $this->SetFont('Arial', 'I', 10);
      $this->Cell(96, 10, utf8_decode("Av. Daniel A. Carrion Nro. 511 (Ct Diresa, Porton Plomo de Metal)"), 0, 0, '', 0);
      $this->Ln(5);

      /* TELEFONO */
      $this->Cell(15);  // mover a la derecha
      $this->SetFont('Arial', 'B', 10);
      $this->Cell(59, 10, utf8_decode("RUC: "), 0, 0, '', 0);

      $this->Cell(-39);  // mover a la derecha
      $this->SetFont('Arial', 'I', 10);
      $this->Cell(96, 10, utf8_decode("20185862748"), 0, 0, '', 0);
      $this->Ln(5);
      ...
      $this->SetFont('Arial', 'I', 10);
      $this->Cell(96, 10, utf8_decode("caritas.abancay@caritas.pe"), 0, 0, '', 0);
      $this->Ln(5);
      ...
      $this->Cell(-65);  // mover a la derecha
      $this->SetFont('Arial', 'I', 10);
      $this->Cell(96, 10, utf8_decode("Abancay"), 0, 0, '', 0);
      $this->Ln(10);
