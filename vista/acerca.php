...
<div class="page-content">
  ...
  <h4 class="text-center text-secodary">DATOS DE LA EMPRESA</h4>
    ...
    <div class="row">
          <form action="" method="POST">
            ...
            <input type="text" placeholder="Id empresa" class="input input__text" name="txtid" value="<?= $datos->id_empresa?>">
            </div>
            <div class="fl-flex-label mb-4 px-2 col-12 col-md-6">
            <input type="text" placeholder="Nombre empresa" class="input input__text" name="txtnombre" value="<?= $datos->nombre?>">
            </div>
            <div class="fl-flex-label mb-4 px-2 col-12 col-md-6">
