...
<div class="page-content">
  ...
  <h4 class="text-center text-secodary">OFICINAS - CARITAS ABANCAY</h4>
 ...
 include "../controlador/controlador_eliminar_cargo.php";
  ...
  ?>
    ...
    <a href="registro_cargo.php" class="btn btn-primary btn-rounded mb-2"><i class="fa-solid fa-user-plus"></i>&nbsp;Registrar</a>
    ...
    <tr>
      ...
      <td>
           <a href=""  data-toggle="modal" data-target="#exampleModal<?= $datos->id_cargo ?>" class="btn btn-warning"><i class="fa-solid fa-pen-to-square"></i></a>
            <a class="btn btn-danger" href="cargo.php?id=<?= $datos->id_cargo ?>" onclick="advertencia(event)"><i class="fa-solid fa-trash"></i></a>
