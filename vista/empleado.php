...
<div class="page-content">
  ...
  <h4 class="text-center text-secodary">LISTA DE EMPLEADOS</h4>
  ...
  ?>
    ...
    <a href="registro_empleado.php" class="btn btn-primary btn-rounded mb-2"><i class="fa-solid fa-user-plus"></i>&nbsp;Registrar</a>
    ...
    <tr>
      ...
      <td>
           <a href=""  data-toggle="modal" data-target="#exampleModal<?= $datos->id_empleado ?>" class="btn btn-warning"><i class="fa-solid fa-pen-to-square"></i></a>
            <a class="btn btn-danger" href="empleado.php?id=<?= $datos->id_empleado ?>" onclick="advertencia(event)"><i class="fa-solid fa-trash"></i></a>
                      ...
                      <div class="modal-dialog">
                        <div class="modal-content">
                          ...
                          <form action="" method="POST">
                                ...
                                <div class="fl-flex-label mb-4 px-2 col-12">
                                  <input type="text" placeholder="Apellidos" class="input input__text" name="txtapellido" value="<?= $datos->apellido?>">
                                </div>
                                <div class="fl-flex-label mb-4 px-2 col-12">
                                  <input type="text" placeholder="DNI" class="input input__text" name="txtdni" value="<?= $datos->dni?>">
                                </div>
                                <div class="fl-flex-label mb-4 px-2 col-12">
                                 <select name="txtcargo" placeholder="Cargo" class="input input__select">
                                  <?php
