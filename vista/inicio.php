...
<div class="page-content">
  ...
  <h4 class="text-center text-secodary">ASISTENCIA DE EMPLEADOS</h4>
...
FROM
  ...
  <tbody>
    ...
    <tr>
      ...
      <td><?= $datos->salida?></td>
      <td>
            <a class="btn btn-danger" href="inicio.php?id=<?=$datos->id_asistencia?>" onclick="advertencia(event)"><i class="fa-solid fa-trash"></i></a>
